...
export const watches: Watch[] = [
  // Classic Collection
  {
    ...
    style: 'classic',
    features: ['Функція дати', 'Сапфірове скло', 'Браслет Jubilee', 'Хронометр COSC'],
    specifications: {
  ...
  },
  {
    ...
    style: 'classic',
    features: ['Функція дати', 'Сапфірове скло', 'Браслет Oyster', 'Хронометр COSC'],
    specifications: {
      case: 'Oystersteel та біле золото',
      movement: 'Автоматичний калібр 3235',
      waterResistance: '100 метрів',
  ...
  },
  {
    ...
    style: 'classic',
    features: ['Функція дати', 'Сапфірове скло', 'Браслет Jubilee', 'Автопідзавод'],
    specifications: {
  ...
  },
  {
    ...
    style: 'classic',
    features: ['Автоматичний механізм', 'Сапфірове скло', 'Водонепроникність', 'Хронометр COSC'],
    specifications: {
      case: 'Oystersteel',
  ...
  },
  {
    ...
    style: 'classic',
    features: ['Автоматичний механізм', 'Сапфірове скло', 'Водонепроникність', 'Унікальний колір'],
    specifications: {
      case: 'Oystersteel',
      movement: 'Автоматичний калібр 3230',
      waterResistance: '100 метрів',
  ...
  },
  {
    ...
    style: 'classic',
    features: ['Авіаційний стиль', 'Великі цифри', 'Антимагнітний', 'Chromalight'],
    specifications: {
      case: 'Oystersteel',
      movement: 'Автоматичний калібр 3230',
      waterResistance: '100 метрів',
  ...
  // Sport Collection
  {
    ...
    style: 'sport',
    features: ['Хронограф', 'Тахиметрична шкала', 'Керамічний безель', '72-годинний запас ходу'],
    specifications: {
  ...
  },
  {
    ...
    images: [
      ...
      'https://images.unsplash.com/photo-1639006410127-2d8a4de35c2a?w=800&q=80',
    ],
    style: 'sport',
    features: ['Два часові пояси', 'Керамічний безель', '24-годинна стрілка', 'Швидка зміна дати'],
    specifications: {
      case: 'Oystersteel',
  ...
  },
  {
    ...
    style: 'sport',
    features: ['Два часові пояси', 'Керамічний безель', '24-годинна стрілка', 'Нічний стиль'],
    specifications: {
      case: 'Oystersteel',
      movement: 'Автоматичний калібр 3285',
      waterResistance: '100 метрів',
  ...
  },
  {
    ...
    style: 'sport',
    features: ['Рожеве золото Everose', 'Двонаправлений безель', 'Oysterflex браслет', 'Chromalight підсвітка'],
    specifications: {
  ...
  },
  {
    ...
    style: 'sport',
    features: ['24-годинна стрілка', 'Фіксований безель', 'Chromalight', 'Хронометр COSC'],
    specifications: {
      case: 'Oystersteel',
      movement: 'Автоматичний калібр 3285',
      waterResistance: '100 метрів',
  ...
  },
  {
    ...
    style: 'sport',
    features: ['Водонепроникність 300м', 'Керамічний безель', 'Сапфірове скло', 'Автоматичний механізм'],
    specifications: {
      case: 'Oystersteel',
      movement: 'Автоматичний калібр 3235',
  ...
  },
  {
    ...
    style: 'sport',
    features: ['Водонепроникність 300м', 'Зелений керамічний безель', 'Сапфірове скло', 'Колекційна модель'],
    specifications: {
      case: 'Oystersteel',
      movement: 'Автоматичний калібр 3235',
      waterResistance: '300 метрів',
  ...
  },
  {
    ...
    style: 'sport',
    features: ['Антимагнітний', 'Зелене сапфірове скло', 'Помаранчева стрілка', 'Хронометр COSC'],
    specifications: {
      case: 'Oystersteel',
  ...
  // Dress Collection
  {
    ...
    style: 'dress',
    features: ['День тижня повністю', 'Золотий корпус', 'Ексклюзивний циферблат', 'Браслет President'],
    specifications: {
  ...
  },
  {
    ...
    style: 'dress',
    features: ['День тижня повністю', 'Біле золото', 'Римські цифри', 'Браслет President'],
    specifications: {
      case: '18К біле золото',
      movement: 'Автоматичний калібр 3255',
      waterResistance: '100 метрів',
  ...
  },
  {
    ...
    style: 'dress',
    features: ['Фази місяця', 'Емальований циферблат', 'Біле золото', 'Шкіряний ремінець'],
    specifications: {
      case: '18К біле золото',
  ...
  },
  {
    ...
    style: 'dress',
    features: ['Класичний дизайн', 'Рожеве золото', 'Білий лакований циферблат', 'Шкіряний ремінець'],
    specifications: {
  ...
  },
  {
    ...
    style: 'dress',
    features: ['Річний календар', 'Два часові пояси', 'Кільце Command', 'Інноваційний механізм'],
    specifications: {
      case: '18К біле золото',
  ...
  },
  {
    ...
    style: 'dress',
    features: ['Річний календар', 'Два часові пояси', 'Жовте золото', 'Браслет Oyster'],
    specifications: {
      case: '18К жовте золото',
      movement: 'Автоматичний калібр 9001',
      waterResistance: '100 метрів',
  ...
  },
  {
    ...
    style: 'dress',
    features: ['Діамантовий безель', 'Перламутровий циферблат', 'Біле золото', 'Браслет Pearlmaster'],
    specifications: {
  ...
  },
  {
    ...
    style: 'dress',
    features: ['Компактний розмір', 'Жіночий дизайн', 'Браслет Jubilee', 'Діамантові індекси'],
    specifications: {
...
export const brands = ['Royal Crown'] as const;
export const styles = ['classic', 'sport', 'dress'] as const;

export const styleLabels: Record<(typeof styles)[number], string> = {
  classic: 'Класичні',
  sport: 'Спортивні',
  dress: 'Елегантні',
};
...
export const materials = Array.from(
  new Set(watches.map((w) => w.specifications.case).filter(Boolean))
).sort((a, b) => a.localeCompare(b, 'uk'));

export const movements = Array.from(
  new Set(watches.map((w) => w.specifications.movement).filter(Boolean))
).sort((a, b) => a.localeCompare(b, 'uk'));
